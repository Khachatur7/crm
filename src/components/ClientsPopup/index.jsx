...
export default function ClientsPopup({ isVisible, setIsVisible, client }) {
      ...
      <div className={`clients-popup ${isVisible ? "active" : ""}`}>
        <div className="clients-popup__info">
          ...
          <div className="clients-popup__wrapper">
            <img alt="Жуков Антон" src="/src/assets/images/client-1.png" />
          </div>
          <h2 className="clients-popup__title">
            {client?.surname} {client?.name}
          </h2>
          <span className="clients-popup__text">
          ...
          {activeTab === 3 && (
            <div className="clients-popup__statistics">
              ...
              <div className="clients-popup__row">
                ...
                <span className="clients-popup__value">{client?.Info.Stats[0].sum}₽</span>
              </div>
              <div className="clients-popup__row">
                <span className="clients-popup__criteria">Средний чек</span>
                <span className="clients-popup__value">{client?.Info.Stats[0].AverageCheck}₽</span>
              </div>
              <div className="clients-popup__row">
                <span className="clients-popup__criteria">Последний визит</span>
                <span className="clients-popup__value">{client?.lastvisit}</span>
              </div>
              <div className="clients-popup__row">
                <span className="clients-popup__criteria">
